    ...
    <div className=' absolute top-0 -right-full   overflow-y-auto flex justify-center h-screen w-24 z-40 xl:hidden '>
        <div className={`xl:hidden ${!open ? 'translate-x-0 ease-out' : '-translate-x-full overflow-y-auto fixed'} h-full w-full  transition-all text-xl duration-500 ease text-white font-gilroy-regular bg-gradient-to-br z-50 from-gray-600 to-gray-800 flex flex-col items-center`}>
          ...
          <div className=' flex flex-col gap-5 '>
            ...
            dropIndustries && 
            <div className="flex flex-col w-[90%] m-auto  rounded-lg">
              <Link to='/industries/communication'><div className='text-white p-4 border-b-[1px] w-full border-b-gray-500 '>Communication</div></Link> 
             <Link to='/industries/hospitality'><div className='text-white p-4 border-b-[1px] w-full border-b-gray-500 '>Logistics</div></Link> 
             <Link to='/industries/logistics'><div className='text-white p-4 border-b-[1px] w-full border-b-gray-500 '> Retail</div></Link> 
             <Link to='/industries/public-sector'><div className='text-white p-4 border-b-[1px] w-full border-b-gray-500 '>Banking and Finances</div></Link> 
             <Link to='/industries/retail'><div className='text-white p-4 border-b-[1px] w-full border-b-gray-500 '>Public Sector</div></Link> 
          ...
          <NavLink to='https://startups.hubnex.in' className={`  bg- text-lime-500 border-t-2 border-b-2 w-full border-b-gray-500 border-t-gray-500 py-5 px-5`}>Startup Program</NavLink>
